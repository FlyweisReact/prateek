...
import styles from "./eventDelegates.module.css"
...
const EventWiseDelegates = () => {
  ...
  return (
    ...
    <div className={styles.header}>
      <div className={styles.title}>Event Wise Delegates</div>
...
export default EventWiseDelegates;

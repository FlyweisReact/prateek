...
import styles from "./delegatesSummary.module.css"
...
const data = [
  ...
  },
  {
    name: 'FAI 2017',
    Active_Delegates: 4000,
    Inactive_Delegates: 2100,
    Guest_Users: 2000,
    amt: 2400,
  },
];

const DelegatesSummary = () => {
  ...
  return (
    ...
    <div className={styles.header}>
      <div className={styles.title}>Delegates Summary</div>
...
export default DelegatesSummary;

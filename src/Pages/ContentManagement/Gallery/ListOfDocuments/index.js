...
const columns = [
  { Header: "#", accessor: "id" },
  { Header: "Documents Details Id", accessor: "documentsDetailsId" },
...
const ListOfDocuments = () => {
  ...
  const exportToExcel = () => {
    const wsData = data.map((item) => ({
      ID: item.id,
      "Documents Details Id": item.documentsDetailsId,
  "Label": item.label,
 ...
 "File Path": item.filePath,
  ...
  return (
    ...
    <div className={`yourComponent ${isExpanded ? "expanded" : ""}`}>
      <div className="horizontalLine"></div>
      <div className="header">
        <div className="title">List of Documents</div>

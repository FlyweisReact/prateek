...
const ProfileCard = ({ user }) => {
  ...
  return (
    ...
    margin: "35px"}}>{user.name}</h2>
      <div className="pr-middle-div">
        <button>Contact</button>
        <button>Organisation</button>
      </div>
      <div  className="pr-lower-div">
...
const routes = [
  { name: "Home" },
  { name: "Profile" },
  { name: "Add Company Category" },
  { name: "List Company Category" },
  {  name: "Add Location" },
  { name: "Location List" },
  { name: "Add Company" },
  ...
  {  name: "Add Event Organizer" },
  {  name: "List Event Organizer" },
  { name: "Add New Session" },
  { name: "List of Session" },
  { name: "Add New Event" },
  { name: "List of Events" },
  ...
  { name: "Add New Exhibitor" },
  { name: "List of Exhibitors" },
  { name: "Add Event Schedule" },
  {name: "List Event Schedule" },
  { name: "Add New Delegate" },
  { name: "List of Delegates" },
  { name: "Delegate Attendance" },
  {  name: "Add New Helpline" },
  { name: "List of Helplines" },
  {  name: "Add Feedback Parameters" },
  { name: "List of Feedback Parameters" },
  { name: "Add New Advertisement" },
  { name: "List of Advertisements" },
  ...
  { name: "Add DG Message" },
  { name: "Add Banners" },
  { name: "Add Event Location Facts" },
  {  name: "List of Facts" },
  {  name: "List of Location Banners" },
  { name: "Add Registration Details" },
  {  name: "Add Exhibition Details" },
  { name: "Add Meeting Details" },
  {  name: "List of Meetings" },
  { name: "Add About Organization" },
  { name: "Event Delegates" },
  { name: "Summary Report" },
  {name: "Address Level for Delegates" },
  { name: "Feedbacks" },
  { name: "List of Menus" },
  {  name: "Menu Details" },
];
        ...
        <div className={styles.header}>
          <div className={styles.headerContent}>
            ...
            <div className={styles.rightHeaderContent}>
              ...
              <span className={styles.username} onClick={toggleProfileCard}>Username</span>
        ...
        <div className={styles.content}>
          ...
          >
            ...
            <div className="search-result-div">
              {searchTerm !== "" && searchPages().map((route, index) => (
